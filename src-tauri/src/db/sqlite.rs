...
use super::*;
use crate::domain::{model::GameResultType, tiebreak::TiebreakType};
...
impl Db for SqliteDb {
    ...
    async fn create_team(
        &self,
        data: crate::domain::dto::CreateTeam,
    ) -> Result<crate::domain::model::Team, sqlx::Error> {
        let result = sqlx::query_as(
    ...
    async fn update_team(
        &self,
        data: crate::domain::dto::UpdateTeam,
    ) -> Result<crate::domain::model::Team, sqlx::Error> {
        let result = sqlx::query_as(
            "UPDATE teams SET 
                name = COALESCE(?, name),
    ...
    async fn get_teams_by_tournament(
        &self,
        tournament_id: i32,
    ) -> Result<Vec<crate::domain::model::Team>, sqlx::Error> {
    ...
    async fn search_teams(
        &self,
        filters: crate::domain::dto::TeamSearchFilters,
    ) -> Result<Vec<crate::domain::model::Team>, sqlx::Error> {
    ...
    async fn add_player_to_team(
        &self,
        data: crate::domain::dto::AddPlayerToTeam,
    ) -> Result<crate::domain::model::TeamMembership, sqlx::Error> {
        let result = sqlx::query_as(
    ...
    async fn remove_player_from_team(
        &self,
        data: crate::domain::dto::RemovePlayerFromTeam,
    ) -> Result<(), sqlx::Error> {
    ...
    async fn get_team_memberships(
        &self,
        team_id: i32,
    ) -> Result<Vec<crate::domain::model::TeamMembership>, sqlx::Error> {
        let result = sqlx::query_as(
    ...
    async fn create_team_match(
        &self,
        data: crate::domain::dto::CreateTeamMatch,
    ) -> Result<crate::domain::model::TeamMatch, sqlx::Error> {
        let result = sqlx::query_as(
    ...
    async fn update_team_match(
        &self,
        data: crate::domain::dto::UpdateTeamMatch,
    ) -> Result<crate::domain::model::TeamMatch, sqlx::Error> {
        let result = sqlx::query_as(
    ...
    ) -> Result<Vec<crate::domain::model::TeamMatch>, sqlx::Error> {
    ...
    async fn create_team_lineup(
        &self,
        data: crate::domain::dto::CreateTeamLineup,
    ) -> Result<crate::domain::model::TeamLineup, sqlx::Error> {
        let result = sqlx::query_as(
    ...
    async fn get_team_lineups(
        ...
        team_id: i32,
        round_number: i32,
    ) -> Result<Vec<crate::domain::model::TeamLineup>, sqlx::Error> {
    ...
    async fn create_team_tournament_settings(
        &self,
        data: crate::domain::dto::CreateTeamTournamentSettings,
    ) -> Result<crate::domain::model::TeamTournamentSettings, sqlx::Error> {
        let result = sqlx::query_as(
    ...
    async fn update_team_tournament_settings(
        &self,
        data: crate::domain::dto::UpdateTeamTournamentSettings,
    ) -> Result<crate::domain::model::TeamTournamentSettings, sqlx::Error> {
        let result = sqlx::query_as(
