...
pub struct TeamPairingResultDto {
    ...
    pub individual_pairings: Vec<crate::domain::model::Pairing>,
...
pub struct ExtendedTeamStandingDto {
    ...
    pub players: Vec<crate::domain::model::Player>,
...
pub async fn calculate_team_standings(
    ...
    let board_weight_system = match config.board_weight_system.as_str() {
        "equal" => crate::service::team_scoring::BoardWeightSystem::Equal,
        "descending" => crate::service::team_scoring::BoardWeightSystem::Descending,
        "ascending" => crate::service::team_scoring::BoardWeightSystem::Ascending,
        _ => {
            return Err(crate::common::error::PawnError::InvalidInput(
...
mod tests {
    ...
    async fn test_team_scoring_command_coverage() {
        ...
        let _board_weight_system = match config.board_weight_system.as_str() {
            ...
            "descending" => crate::service::team_scoring::BoardWeightSystem::Descending,
            "ascending" => crate::service::team_scoring::BoardWeightSystem::Ascending,
            _ => crate::service::team_scoring::BoardWeightSystem::Equal,
        };
