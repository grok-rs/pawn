...
pub async fn initialize_knockout_tournament(
    ...
    if players.len() < 2 {
        return Err(crate::common::error::PawnError::InvalidInput(
...
mod tests {
    ...
    async fn knockout_service_calculate_rounds_contract() {
        ...
        let rounds = crate::service::knockout::KnockoutService::calculate_rounds(8);
        assert!(rounds > 0);
    ...
    async fn knockout_service_advance_winners_contract() {
        ...
        let next_positions =
            crate::service::knockout::KnockoutService::advance_winners(1, 1, &winner_results);
    ...
    async fn knockout_service_pairing_generation_contract() {
        ...
        let pairings = crate::service::knockout::KnockoutService::generate_round_pairings(
            1, 1, &positions,
        );
    ...
    async fn knockout_service_tournament_completion_contract() {
        ...
        let positions = vec![]; // Empty positions
        let is_complete =
            crate::service::knockout::KnockoutService::is_tournament_complete(&positions, 3);
    ...
    async fn knockout_service_bracket_validation_contract() {
        ...
        let validation_result =
            crate::service::knockout::KnockoutService::validate_bracket(&positions);
    ...
    async fn command_knockout_round_calculations() {
        ...
        for (players, expected_rounds) in test_cases {
            let calculated_rounds =
                crate::service::knockout::KnockoutService::calculate_rounds(players);
            assert_eq!(
    ...
    async fn command_knockout_winner_results_coverage() {
        ...
        for (round, scenario) in test_scenarios.iter().enumerate() {
            let next_positions = crate::service::knockout::KnockoutService::advance_winners(
                1,
                round as i32 + 1,
                scenario,
            );
    ...
    async fn command_knockout_enhanced_testing() {
        ...
        assert_eq!(
            crate::service::knockout::KnockoutService::calculate_rounds(3),
            2
        );
        assert_eq!(
            crate::service::knockout::KnockoutService::calculate_rounds(1),
            0
        ...
        let empty_positions =
            crate::service::knockout::KnockoutService::advance_winners(1, 1, &empty_results);
        assert!(empty_positions.is_empty());

        // Test service methods with various inputs
        let positions = vec![];
        let winner_id =
            crate::service::knockout::KnockoutService::get_tournament_winner(&positions, 3);
    ...
    async fn command_knockout_boundary_conditions() {
        ...
        let calculated_rounds =
            crate::service::knockout::KnockoutService::calculate_rounds(large_player_count);
        ...
        // Test zero players
        let zero_rounds = crate::service::knockout::KnockoutService::calculate_rounds(0);
        assert_eq!(zero_rounds, 0);

        // Test negative player count (edge case)
        let negative_rounds = crate::service::knockout::KnockoutService::calculate_rounds(-5);
    ...
    async fn command_knockout_winner_advancement_comprehensive() {
        ...
        let final_positions = crate::service::knockout::KnockoutService::advance_winners(
            1,
            4, // Final round
            &final_round_winner,
        );
    ...
    async fn command_knockout_bracket_status_validation() {
        ...
        let empty_validation =
            crate::service::knockout::KnockoutService::validate_bracket(&empty_positions);
        ...
        let incomplete_tournament_3_rounds =
            crate::service::knockout::KnockoutService::is_tournament_complete(
                &empty_positions,
                3,
            );
        ...
        let no_winner = crate::service::knockout::KnockoutService::get_tournament_winner(
            &empty_positions,
            3,
        );
        ...
        let no_rounds_winner =
            crate::service::knockout::KnockoutService::get_tournament_winner(
                &empty_positions,
                0,
            );
    ...
    async fn test_command_logic_coverage() {
        ...
        let players_count = 8;
        let total_rounds =
            crate::service::knockout::KnockoutService::calculate_rounds(players_count);
        assert_eq!(total_rounds, 3);

        // Test generate_first_round_positions call (line 77-78)
        let players = vec![];
        let positions =
            crate::service::knockout::KnockoutService::generate_first_round_positions(
                1, players,
            );
        ...
        let next_positions =
            crate::service::knockout::KnockoutService::advance_winners(1, 2, &winner_results);
        ...
        if vec![1, 2].is_empty() {
            ...
            let _error = crate::common::error::PawnError::InvalidInput(
                "At least 2 players required for knockout tournament".to_string(),
            );
        }
    }
    ...
    async fn test_command_function_execution_coverage() {
        ...
        if players.len() >= 2 {
            ...
            let total_rounds = crate::service::knockout::KnockoutService::calculate_rounds(
                players.len() as i32,
            );
        ...
        if let Ok(Some(bracket)) = bracket_result {
            ...
            let winner_id = crate::service::knockout::KnockoutService::get_tournament_winner(
                &positions,
        ...
        match crate::service::knockout::KnockoutService::validate_bracket(&positions) {
            Ok(()) => {
    ...
    async fn test_knockout_error_handling_and_edge_cases() {
        ...
        let single_player: Vec<crate::domain::model::Player> = vec![];
        if single_player.len() < 2 {
            let error = crate::common::error::PawnError::InvalidInput(
                "At least 2 players required for knockout tournament".to_string(),
            );
            match error {
                crate::common::error::PawnError::InvalidInput(msg) => {
        ...
        for (positions, rounds) in winner_test_cases {
            let winner = crate::service::knockout::KnockoutService::get_tournament_winner(
                &positions, rounds,
            );
    ...
    async fn test_knockout_command_workflow_simulation() {
        ...
        let _round_1_pairings =
            crate::service::knockout::KnockoutService::generate_round_pairings(
                bracket.id,
                1,
        ...
        let _is_complete = crate::service::knockout::KnockoutService::is_tournament_complete(
            &all_positions,
            total_rounds,
        );
        ...
        let validation_result =
            crate::service::knockout::KnockoutService::validate_bracket(&all_positions);
