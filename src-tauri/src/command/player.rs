...
#[cfg(test)]
use crate::domain::dto::BulkImportPlayer;
...
use crate::domain::model::{Player, PlayerCategory, PlayerCategoryAssignment, RatingHistory};
...
mod tests {
    ...
    async fn create_test_tournament(state: &PawnState) -> crate::domain::model::Tournament {
        use crate::domain::dto::CreateTournament;
