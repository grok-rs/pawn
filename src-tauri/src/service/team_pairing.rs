...
impl<D: Db> TeamPairingEngine<D> {
    ...
    async fn generate_swiss_team_pairings(
        &self,
        teams: Vec<Team>,
        memberships: Vec<crate::domain::model::TeamMembership>,
    ...
    async fn generate_individual_board_pairings(
        ...
        memberships: &[crate::domain::model::TeamMembership],
        config: &TeamPairingConfig,
    ...
    fn calculate_team_average_rating(
        ...
        let team_players: Vec<&crate::domain::model::TeamMembership> = memberships
            .iter()
    ...
    fn get_team_players(
        ...
        let team_members: Vec<&crate::domain::model::TeamMembership> = memberships
            .iter()
            .filter(|m| m.team_id == team_id)
            .collect();
