...
impl SwissPairingEngine {
    ...
    fn respects_absolute_color_preference(
        &self,
        player: &SwissPlayer,
        assigned_color: Color,
    ) -> bool {
    ...
    fn calculate_max_federation_violations(
        &self,
    ...
    fn calculate_team_avoidance_penalty(
        &self,
        player1: &SwissPlayer,
        player2: &SwissPlayer,
    ) -> f64 {
...
mod tests {
    use super::*;
    use crate::domain::model::{Game, Player, PlayerResult};
